...
| Catalog | full schema-v14 object as the governed resource; `EmbodimentId` in segment/checkpoint rows | fail-closed parsing, ID resolution, asset promotion, and lineage |
